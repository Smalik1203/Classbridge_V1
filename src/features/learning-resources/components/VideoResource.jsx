 ...
 */
const VideoResource = React.memo(function VideoResource({ resource, canEdit = false, onEdit = () => {}, onDelete = () => {} }) {
  const { user } = useAuth();
  ...
  // Only re-render if resource ID, canEdit flag, or content_url changes
  return prevProps.resource.id === nextProps.resource.id &&
         prevProps.canEdit === nextProps.canEdit &&
         prevProps.resource.content_url === nextProps.resource.content_url;
});
