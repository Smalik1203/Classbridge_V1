...
import { DollarOutlined, EyeOutlined, FilePdfOutlined, MoreOutlined, MailOutlined, BellOutlined } from '@ant-design/icons';
          ...
          <Space size={4}>
            ...
            {balance > 0 && (
              <Tooltip title="Record payment">
                <Button size="small" type="text" icon={<DollarOutlined />} onClick={() => onRecordPayment?.(r)} />
              </Tooltip>
            )}
            <Dropdown
              menu={{
