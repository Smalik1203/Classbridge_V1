...
import { getFullName, getSchoolName } from '@/shared/utils/metadata';
...
const AdminDashboard = () => {
  ...
  const userName = getFullName(user) || 'Admin';
          ...
          return (
            <div key={index} style={{ 
              ...
              <div className="flex items-center justify-between">
                ...
                <Icon style={{ width: '32px', height: '32px', color: stat.color === 'blue' ? '#3B82F6' : stat.color === 'green' ? '#10b981' : stat.color === 'purple' ? '#6366F1' : '#f59e0b' }} />
              </div>
            </div>
          );
        })}
          ...
          <div className="space-y-3">
            ...
            */}
            ...
            <div style={{ 
              ...
              <Clock style={{ width: '20px', height: '20px', color: '#06b6d4' }} />
              <div>
                <p style={{ 
                  color: '#1e293b', 
                  fontSize: '14px', 
        ...
        <div style={{ 
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button style={{ 
              ...
              <Calendar style={{ width: '24px', height: '24px', color: '#3B82F6', marginBottom: '8px' }} />
              <p style={{ 
                color: '#1e293b', 
                fontSize: '14px', 
                fontWeight: 500,
            ...
            <button style={{ 
              ...
              <Users style={{ width: '24px', height: '24px', color: '#06b6d4', marginBottom: '8px' }} />
              <p style={{ 
                color: '#1e293b', 
                fontSize: '14px', 
                fontWeight: 500,
