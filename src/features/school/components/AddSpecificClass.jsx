...
import { getSchoolCode, getSchoolName, getSuperAdminCode } from '@/shared/utils/metadata';
          ...
          <Form form={classForm} layout="vertical" onFinish={handleClassSubmit} size="large">
            ...
            <Form.Item>
              <Button
                ...
                disabled={academicYears.length === 0}
                style={{
                  background: academicYears.length === 0 ? '#d1d5db' : '#3B82F6',
                  borderColor: academicYears.length === 0 ? '#d1d5db' : '#3B82F6',
                  borderRadius: '8px',
                  fontWeight: 500,
                }}
              >
