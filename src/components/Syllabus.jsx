...
export default function SyllabusPage() {
  ...
  useEffect(() => {
    ...
    setChapters([]);
    setExpandedChapters(new Set());
  }, [subjectId, classInstanceId, me?.school_code]);
      ...
      <Card style={{ marginBottom: 24 }}>
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          <div>
            ...
            <Text type="secondary">Create and manage chapters and topics for your subjects</Text>
          </div>
        ...
        <Card>
          ...
          {chapters.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '60px 20px' }}>
              ...
              <Title level={4} type="secondary">No chapters yet</Title>
              <Text type="secondary" style={{ display: 'block', marginBottom: 24 }}>
                Start building your syllabus by adding the first chapter
              </Text>
              {canEdit && (
                <Button 
                  type="primary" 
                ...
                <Panel
                  ...
                  header={
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      {chapter.ref_code && (
                        <Tag color="geekblue">{chapter.ref_code}</Tag>
                      )}
                      <Text type="secondary" style={{ fontSize: '12px' }}>
