...
// Ensure week starts from Monday (Sunday = 0, Monday = 1, ..., Saturday = 6)
dayjs.locale('en');
...
export default function CalendarMonthView({
  ...
  const isWeekendDate = (date) => {
    ...
    // Only Sunday should be treated as weekend
    
    // Debug: Check what day of the week Saturday is
    if (date.format('dddd') === 'Saturday') {
      // Debug logging removed
    }
    
    return dayOfWeek === 0 && date.format('dddd') === 'Sunday';
  };
  ...
  const getCalendarDays = () => {
    ...
    const startOfWeek = startOfMonth.startOf('week').add(1, 'day'); // Add 1 to get Monday instead of Sunday
