...
export const lightTheme = {
  ...
  components: {
    ...
    Menu: {
      ...
      colorItemBgSelected: BRAND_PRIMARY,
      colorItemBgHover: NEUTRALS.N50,
      colorItemText: NEUTRALS.N700,
      colorItemTextSelected: '#ffffff',
      colorItemTextHover: NEUTRALS.N900,
      colorSubItemBg: 'transparent',
      colorSubItemBgHover: NEUTRALS.N50,
      colorSubItemBgSelected: BRAND_PRIMARY,
      colorSubItemText: NEUTRALS.N600,
      colorSubItemTextHover: NEUTRALS.N900,
      colorSubItemTextSelected: '#ffffff',
      colorGroupTitle: NEUTRALS.N500,
...
export const darkTheme = {
  ...
  components: {
    ...
    Menu: {
      ...
      colorItemBg: 'transparent',
      colorItemBgSelected: BRAND_PRIMARY,
      colorItemBgHover: NEUTRALS.N800,
      colorItemText: NEUTRALS.N300,
      colorItemTextSelected: '#ffffff',
      colorItemTextHover: NEUTRALS.N50,
      colorSubItemBg: 'transparent',
      colorSubItemBgHover: NEUTRALS.N800,
      colorSubItemBgSelected: BRAND_PRIMARY,
      colorSubItemText: NEUTRALS.N400,
      colorSubItemTextHover: NEUTRALS.N50,
      colorSubItemTextSelected: '#ffffff',
      colorGroupTitle: NEUTRALS.N500,
